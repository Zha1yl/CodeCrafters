...
const HomePage = () => {
  return (
    <main className="main">
      ...
      <p className="main__text">
        А если вы хотите узнать больше о математике и теории информатики, у нас
        также есть тысячи часов видеокурсов на
      ...
      <p className="main__text">
        ...
        необходимо построить свою личную сеть и свою репутацию как разработчика.
      </p>
      <p className="main__text">
