    ...
    <div className="container_lesson">
      <div className="algoritm">
        <div className="algoritm__text">
          Научные вычисления с Python <br /> (бета)
        </div>
      ...
      <div className="text">
        <div className="text__descrip">
          ...
          <br />
          анализа данных и манипулирования ими с помощью Python, мощного и<br />
          ...
          <br />
          программирование и способы выполнения сложных вычислений с <br />
